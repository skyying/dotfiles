...
" let s:skeletor.lightblue     = ['#ffd7ff', 225] " 220 231 253 | 220°  89%  93% |
let s:skeletor.yellow        = ['#f3e4a2', 229] " 243 228 162 |  49°  77%  79% |
" let s:skeletor.yellow        = ['#ff5f5f', 203] " 243 228 162 |  49°  77%  79% |
let s:skeletor.yellow        = ['#ffff00', 11] " 243 228 162 |  49°  77%  79% |
let s:skeletor.orange        = ['#ffb793', 216] " 255 183 147 |  20° 100%  79% |
" let s:skeletor.orange        = ['#d7ff00', 190] " 255 183 147 |  20° 100%  79% |
...
let s:skeletor.bluegray      = ['#5f87ff', 69] " 123 148 165 | 204°  19%  56% |
...
"let s:skeletor.comments      = ['#5f5f5f', 59] 
let s:skeletor.comments      = ['#6c6c6c', 242] 
...
call s:hi('LineNr', s:none, s:none) " s:c2 colors bg of line nr's
...
call s:hi('CursorLineNr', s:none, s:none)
...
"call s:hi('ErrorMsg', s:none, s:red)
" error messages on the command line



call s:hi('Search', s:green, s:none, s:reverse)
